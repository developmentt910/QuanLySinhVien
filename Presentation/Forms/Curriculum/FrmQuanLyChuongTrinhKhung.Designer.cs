...
partial class FrmQuanLyChuongTrinhKhung
{
    ...
    private void InitializeComponent()
    {
        ...
        // btnLoad
        // 
        btnLoad.Location = new Point(826, 113);
        btnLoad.Margin = new Padding(4, 5, 4, 5);
        btnLoad.Name = "btnLoad";
        btnLoad.Size = new Size(162, 50);
        btnLoad.TabIndex = 4;
        btnLoad.Text = "Tải";
        ...
        cboHocKy.Location = new Point(591, 123);
        cboHocKy.Margin = new Padding(4, 5, 4, 5);
        cboHocKy.Name = "cboHocKy";
        cboHocKy.Size = new Size(202, 33);
        cboHocKy.TabIndex = 3;
        // 
        // label4
        // 
        label4.AutoSize = true;
        label4.Location = new Point(502, 128);
        ...
        cboChuyenNganh.Location = new Point(169, 123);
        cboChuyenNganh.Margin = new Padding(4, 5, 4, 5);
        cboChuyenNganh.Name = "cboChuyenNganh";
        cboChuyenNganh.Size = new Size(309, 33);
        ...
        cboNganh.Location = new Point(591, 56);
        cboNganh.Margin = new Padding(4, 5, 4, 5);
        cboNganh.Name = "cboNganh";
        cboNganh.Size = new Size(349, 33);
        cboNganh.TabIndex = 1;
        ...
        label2.Location = new Point(502, 61);
        ...
        cboKhoa.Location = new Point(169, 56);
        cboKhoa.Margin = new Padding(4, 5, 4, 5);
        cboKhoa.Name = "cboKhoa";
        cboKhoa.Size = new Size(309, 33);
        cboKhoa.TabIndex = 0;
        ...
        dgvChuongTrinhKhung.Location = new Point(15, 330);
        dgvChuongTrinhKhung.Margin = new Padding(4, 5, 4, 5);
        ...
        // txtTietTH
        // 
        txtTietTH.Location = new Point(879, 119);
        txtTietTH.Margin = new Padding(4, 5, 4, 5);
        txtTietTH.Name = "txtTietTH";
        txtTietTH.ReadOnly = true;
        txtTietTH.Size = new Size(62, 30);
        txtTietTH.TabIndex = 22;
        // 
        // label10
        // 
        label10.AutoSize = true;
        label10.Location = new Point(798, 123);
        ...
        // txtTietLT
        // 
        txtTietLT.Location = new Point(722, 119);
        txtTietLT.Margin = new Padding(4, 5, 4, 5);
        txtTietLT.Name = "txtTietLT";
        txtTietLT.ReadOnly = true;
        txtTietLT.Size = new Size(62, 30);
        txtTietLT.TabIndex = 20;
        // 
        // label9
        // 
        label9.AutoSize = true;
        label9.Location = new Point(641, 123);
        ...
        // txtSoTinChi
        // 
        txtSoTinChi.Location = new Point(566, 119);
        txtSoTinChi.Margin = new Padding(4, 5, 4, 5);
        txtSoTinChi.Name = "txtSoTinChi";
        txtSoTinChi.ReadOnly = true;
        txtSoTinChi.Size = new Size(62, 30);
        txtSoTinChi.TabIndex = 18;
        // 
        // label8
        // 
        label8.AutoSize = true;
        label8.Location = new Point(491, 123);
        ...
        // txtMaHocPhan
        // 
        txtMaHocPhan.Location = new Point(358, 119);
        txtMaHocPhan.Margin = new Padding(4, 5, 4, 5);
        txtMaHocPhan.Name = "txtMaHocPhan";
        txtMaHocPhan.ReadOnly = true;
        txtMaHocPhan.Size = new Size(120, 30);
        txtMaHocPhan.TabIndex = 16;
        // 
        // label7
        // 
        label7.AutoSize = true;
        label7.Location = new Point(274, 123);
        ...
        // txtMaMonHoc
        // 
        txtMaMonHoc.Location = new Point(104, 119);
        txtMaMonHoc.Margin = new Padding(4, 5, 4, 5);
        txtMaMonHoc.Name = "txtMaMonHoc";
        txtMaMonHoc.ReadOnly = true;
        txtMaMonHoc.Size = new Size(153, 30);
        ...
        // btnChangeFilter
        // 
        btnChangeFilter.Location = new Point(779, 191);
        btnChangeFilter.Margin = new Padding(4, 5, 4, 5);
        btnChangeFilter.Name = "btnChangeFilter";
        btnChangeFilter.Size = new Size(162, 50);
        ...
        // btnRemoveMonHoc
        // 
        btnRemoveMonHoc.Location = new Point(22, 191);
        btnRemoveMonHoc.Margin = new Padding(4, 5, 4, 5);
        btnRemoveMonHoc.Name = "btnRemoveMonHoc";
        btnRemoveMonHoc.Size = new Size(235, 50);
        ...
        // btnAddMonHoc
        // 
        btnAddMonHoc.Location = new Point(779, 53);
        btnAddMonHoc.Margin = new Padding(4, 5, 4, 5);
        btnAddMonHoc.Name = "btnAddMonHoc";
        btnAddMonHoc.Size = new Size(162, 50);
        ...
        cboChonMonHoc.Location = new Point(228, 58);
        cboChonMonHoc.Margin = new Padding(4, 5, 4, 5);
        cboChonMonHoc.Name = "cboChonMonHoc";
        cboChonMonHoc.Size = new Size(526, 33);
        ...
        lblTieuDeKhung.Location = new Point(15, 286);
        lblTieuDeKhung.Margin = new Padding(4, 0, 4, 0);
        lblTieuDeKhung.Name = "lblTieuDeKhung";
        lblTieuDeKhung.Size = new Size(307, 25);
        ...
        lblTitle.Size = new Size(1001, 50);
        lblTitle.TabIndex = 4;
